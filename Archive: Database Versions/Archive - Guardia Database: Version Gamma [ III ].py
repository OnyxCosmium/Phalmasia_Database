...
# PLEASE READ THIS! Below are instructions on how to launch the code!
# HEY! If you are reading this, then here are the steps to launch this. You are going to need to download a compiler that
# can run python. Since I used PyCharm to code this updated version, I recommend using that in case plugging it into other
# compilers breaks it (they shouldn't but in case it does, just a heads up). From there, boot it up and make a new project.
# Copy and Paste this code into the window that appears and click the green triangle in the top right corner. Enjoy!
...
while infoBarrier1 == "" or infoBarrier1 == "Return" or infoBarrier1 == "return":
    ...
    while infoBarrier1 == "Characters" or infoBarrier1 == "characters":
        ...
        # Ryner Khabunago Bio
        while infoBarrier2 == "Ryner Khabunago" or infoBarrier2 == "Ryner" or infoBarrier2 == "ryner khabunago" or infoBarrier2 == "ryner":
            # Ryner Bio Prompts
            rynerProfile = "Ryner Khabunago\n\nHometown: Unknown\nRace: Avian (Midnight Blue/Gray/Black [Swirl])\nBirthday: October 13, 4015\nGender: Male\nPronunciation: RYE-ner ka-bun-AH-goh\nMagic Affinities\n| Lightning\n| Shadow\n| Electron Lightning\n\nItems\n| Pendant of the Gatekeeper's Shadow\n\n"
            rynerLightningSpells = "Spells: Lightning\n| Stun Clap\n| Electro Fence\n| Lightning Slice\n| Pact: Voltaic Falchion\n| Lightning Strike\n| Electro Dash\n| Kitsune Cloak\n* Kitsune Cloak: Eye of the Mythics\n* Kitsune Cloak: Tail Guard\n* Kitsune Cloak: Storm Summon\n* Kitsune Cloak: Thunderclap Strike\n* Kitsune Cloak: Tail Concentration\n* Kitsune Cloak: Polarize\n| Kitsune Avatar\n* Kitsune Avatar: Storm Summon\n* Kitsune Avatar: Tail Guard\n* Kitsune Avatar: Tail Concentration\n* Kitsune Avatar: Eye of the Mythics\n* Kitsune Avatar: Stunning Roar\n* Kitsune Avatar: Zeus' Tail\n* Kitsune Avatar: Nabuga's Squall\n\nVoltaic Falchion: Magic Pact\n| Ryner uses his lightning magic, as well as his fixation on power, to shape his lightning into a solid, sharpened mass called a falchion. Because of its composition of lightning magic, it has special properties. It is able to phase through defenses as well as perform instant strikes by using lightning magic. He can also section it by cutting the blade and binding it back together with a bolt of lightning. This allows it to act like a whip. By polarizing it with his Kitsune Cloak, he can control it from a distance as a boomerang-like weapon, as well as constant rotation for improved offense and defense.\n\n"
            ...
            rynerBackstory01 = "Chapter 1\n\nRyner grew up a normal childhood as a Khabunago; a family of " \
                               "grave-watching avians that oversaw graveyards across Phalmasia. The duty of the " \
        ...
        # Serena Fynae Bio
        while infoBarrier2 == "Serena Fynae" or infoBarrier2 == "Serena" or infoBarrier2 == "serena fynae" or infoBarrier2 == "serena":
            # Serena Bio Prompts
    ...
    while infoBarrier1 == "Locations" or infoBarrier1 == "locations":
        infoBarrier2 = input(
            "Continents of Phalmasia:\n| Halgeis\n| Mu'karr\n| Altaria\n| Xhia\n\nLeave the database by entering 'Leave'. Go back to the home prompt by endering 'Back'.\n")

        while infoBarrier2 == "":
            infoBarrier2 = input("Please Re-enter your database restriction.\n")
        while infoBarrier2 != "Halgeis" and infoBarrier2 != "halgeis" and infoBarrier2 != "Mu'karr" and infoBarrier2 != "mu'karr" and infoBarrier2 != "Mukarr" and infoBarrier2 != "mukarr" and infoBarrier2 != "Altaria" and infoBarrier2 != "altaria" and infoBarrier2 != "Xhia" and infoBarrier2 != "xhia" and infoBarrier2 != "Back" and infoBarrier2 != "back" and infoBarrier2 != "Leave" and infoBarrier2 != "leave":
            infoBarrier2 = input("Please Re-enter your database restriction.\n")

        # Halgeis Info & City Selection
        while infoBarrier2 == "Halgeis" or infoBarrier2 == "halgeis":
            ...
            while halgeisLocations == "Volquola" or halgeisLocations == "volquola" or halgeisLocations == "Volquöla" or halgeisLocations == "volquöla":
                halgeisLocations = input(
                    "Volquöla, Halgeis\n\nPrimary Resident Race: Majuu\nPronunciation: vol-KWOH-lah\nLocation: Northwestern Halgeis\nVisitor Friendly: No\nTown Trade:\n| Weapons\n| Armor\nSub-Locations:\n| Voltoru Canyon\n| Pyrevault Ridge\n\nVolquöla is a peaceful town in Northwestern Halgeis and the home to many Majuu, including Aeiyou and Kinto. Volquöla is a town built on the side of Pyrevault Ridge, a volcano that has been inactive for decades. Despite this, it is still extremely hot there, and the average temperature is over 100 degrees Fahrenheit. It has a deep cavern down the side that runs around the northern and eastern side of the town facing towards Mu'Karr called Voltoru Cavern, which hosts a calm and steady flow of magma into the volcano's chamber.\n\nBoth Aeiyou and Kinto grew up in this town and are both light-colored majuu because of it. It hosts many skilled blacksmiths, and it is among some of the main providers of armor and weaponry in Halgeis, which makes it relatively respected in the country. However, most of the villagers prefer to keep to themselves and their community, so the town doesn't get many visitors.\n\nGo back to the other cities of Halgeis by entering 'Return'.\n")

                if halgeisLocations == "Return" or halgeisLocations == "return":
                    break
                if halgeisLocations == "":
                    halgeisLocations = input("Please Re-enter your database restriction.\n")
                if halgeisLocations != "Volquola" and halgeisLocations != "volquola" and halgeisLocations != "Volquöla" and halgeisLocations != "volquöla" and halgeisLocations != "Ashford" and halgeisLocations != "ashford" and halgeisLocations != "Oshborne" and halgeisLocations != "oshborne" and halgeisLocations != "Cilfier" and halgeisLocations != "cilfier" and halgeisLocations != "Skykumo" and halgeisLocations != "skykumo" and halgeisLocations != "Swalubu" and halgeisLocations != "swalubu" and halgeisLocations != "Nulvali" and halgeisLocations != "nulvali" and halgeisLocations != "Starkiepe" and halgeisLocations != "starkiepe" and halgeisLocations != "Grand Elise" and halgeisLocations != "Grand elise" and halgeisLocations != "grand Elise" and halgeisLocations != "grand elise" and halgeisLocations != "Dreklife" and halgeisLocations != "dreklife" and halgeisLocations != "Mezolune" and halgeisLocations != "mezolune" and halgeisLocations != "Piquaron" and halgeisLocations != "piquaron" and halgeisLocations != "Elendraye" and halgeisLocations != "elendraye" and halgeisLocations != "Return" and halgeisLocations != "return" and halgeisLocations != "Leave" and halgeisLocations != "leave":
                    halgeisLocations = input("Please Re-enter your database restriction.\n")

            # Ashford City Commands
            while halgeisLocations == "Ashford" or halgeisLocations == "ashford":
                halgeisLocations = input(
                    "Ashford, Halgeis\n\nPrimary Resident Race: Terrian\nPronunciation: ASH-ford\nLocation: Northern Halgeis\nVisitor Friendly: Yes\nSub-Locations:\n| Kytegrove Forest\n| Frinrir's Gravesite\n\nAshford is a peaceful town on the northern side of Halgeis. The town itself is larger than other common villages in Halgeis because of the regions of Kytegrove Forest it covers, as well as many nearby open fields. Yggdra and her best friend Kiyo call Ashford home. The townspeople are very close-knit and mostly all the residents knows each other, and because of this the residents are very supportive and welcoming to others in the community and outsiders stopping by. Those born with magical capabilities venture to the open fields to spar with one another or find a peaceful, open place to train in solidarity. The town doesn't have any landmarks or produce any products they trade commonly, so Ashford is mostly a quiet settling place for terrians to live a peaceful life with their families.\n\nGo back to the other cities of Halgeis by entering 'Return'.\n")
            ...
            while halgeisLocations == "Oshborne" or halgeisLocations == "oshborne":
                halgeisLocations = input(
                    "Oshborne, Halgeis\n\nPrimary Resident Race: Terrian\nPronunciation: OSH-born\nLocation: Western Halgeis\nVisitor Friendly: Yes\n\nOshborne is a small town in Western Halgeis and one of the many places in Halgeis that Terrians have made their home. This is Cid's home village. This is also the location of the Reimora Family Bakery, where her mother makes baked sweets and sells them at her shop. It hosts a lot of open area that is used when the town commonly holds fairs for various occations like holidays, which are extravagant in their own right.\n\nThe town doesn't act as a tourist attraction since there aren't many things to do there, but the town will openly accept any travelers who happen to be passing through.\n\nGo back to the other cities of Halgeis by entering 'Return'.\n")
            ...
            while halgeisLocations == "Swalubu" or halgeisLocations == "swalubu":
                halgeisLocations = input(
            ...
            while halgeisLocations == "Nulvali" or halgeisLocations == "nulvali":
                halgeisLocations = input(
            ...
            while halgeisLocations == "Starkiepe" or halgeisLocations == "starkiepe":
                halgeisLocations = input(
            ...
            while halgeisLocations == "Grand Elise" or halgeisLocations == "Grand elise" or halgeisLocations == "grand Elise" or halgeisLocations == "grand elise":
                halgeisLocations = input(
            ...
            while halgeisLocations == "Dreklife" or halgeisLocations == "dreklife":
                halgeisLocations = input(
            ...
            while halgeisLocations == "Mezolune" or halgeisLocations == "mezolune":
                halgeisLocations = input(
            ...
            while halgeisLocations == "Elendraye" or halgeisLocations == "elendraye":
                halgeisLocations = input(
            ...
            while halgeisLocations == "":
                halgeisLocations = input("Please Re-enter your database restriction.\n")
            while halgeisLocations != "Volquola" and halgeisLocations != "volquola" and halgeisLocations != "Volquöla" and halgeisLocations != "volquöla" and halgeisLocations != "Ashford" and halgeisLocations != "ashford" and halgeisLocations != "Oshborne" and halgeisLocations != "oshborne" and halgeisLocations != "Cilfier" and halgeisLocations != "cilfier" and halgeisLocations != "Skykumo" and halgeisLocations != "skykumo" and halgeisLocations != "Swalubu" and halgeisLocations != "swalubu" and halgeisLocations != "Nulvali" and halgeisLocations != "nulvali" and halgeisLocations != "Starkiepe" and halgeisLocations != "starkiepe" and halgeisLocations != "Grand Elise" and halgeisLocations != "Grand elise" and halgeisLocations != "grand Elise" and halgeisLocations != "grand elise" and halgeisLocations != "Dreklife" and halgeisLocations != "dreklife" and halgeisLocations != "Mezolune" and halgeisLocations != "mezolune" and halgeisLocations != "Piquaron" and halgeisLocations != "piquaron" and halgeisLocations != "Elendraye" and halgeisLocations != "elendraye" and halgeisLocations != "Return" and halgeisLocations != "return" and halgeisLocations != "Back" and halgeisLocations != "back" and halgeisLocations != "Leave" and halgeisLocations != "leave":
                halgeisLocations = input("Please Re-enter your database restriction.\n")

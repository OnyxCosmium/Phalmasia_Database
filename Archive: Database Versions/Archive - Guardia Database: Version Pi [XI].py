...
# Current Update Notes
    # Rewrote Ryner's Backstory to Fit New Lore
    # Corrected Dates in History for Correct Plot Timing
    # Updated Sectional Sigils in Character Commands (No Mythical Elements)
    # Updated Functionality of Unity & Sectional Sigils in Magic Core Command
        # Added Mana Surge & Mana Baryon Functions & Explanations
    # Added Energy Elevage Branch in Magic Core Command
...
while infoBarrier == "" or infoBarrier == "return":
    ...
    while infoBarrier == "characters":
        ...
        while characterBarrier == "ryner khabunago" or characterBarrier == "ryner":
            ...
            rynerBackstory04 = ("Once she passed her entry exams and had gotten accepted, she had to leave Dullus to live "
                                ...
                                "for her there. She gave him a pendant she had made: a lightning bolt and quill inside of "
                                "a yin-yang orb before she left to remember her by, and left to pack her bags. For her "
                                "first two years, they did just that. But eventually, Quill stopped coming back to Dullus, "
                                "and Ryner didn't see her for another two years.\n\n")
    ...
    while infoBarrier == "magic":
        ...
        if magicBarrier == "energy elevage" or magicBarrier == "elevage":
            energyElevageDescription = ("Energy Elevage is a process that boosts the user's power output by roughly 10%, though it takes "

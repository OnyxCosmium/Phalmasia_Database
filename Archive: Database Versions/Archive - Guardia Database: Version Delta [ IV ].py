...
while infoBarrier == "" or infoBarrier == "Return" or infoBarrier == "return":
    ...
    while infoBarrier == "Magic" or infoBarrier == "magic":
        ...
        while magicBarrier != "Fire" and magicBarrier != "fire" and magicBarrier != "Water" and magicBarrier != "water" and magicBarrier != "Lightning" and magicBarrier != "lightning" and magicBarrier != "Wind" and magicBarrier != "wind" and magicBarrier != "Ice" and magicBarrier != "ice" and magicBarrier != "Earth" and magicBarrier != "earth" and magicBarrier != "Shadow" and magicBarrier != "shadow" and magicBarrier != "Nature" and magicBarrier != "nature" and magicBarrier != "Life" and magicBarrier != "life" and magicBarrier != "Gravity" and magicBarrier != "gravity" and magicBarrier != "Back" and magicBarrier != "back" and magicBarrier != "Leave" and magicBarrier != "leave":
            magicBarrier = input("Please Re-enter your database restriction.\n")
    ...
    while infoBarrier == "Races" or infoBarrier == "races":
        raceBarrier = input(
            "Besides humans, there are four different races that inhabit Phalmasia: Terrians, Argens, Avats, and Majuu. Each of them primarily inhabit one continent of Phalmasia, and have different ways of life, as well as unique characteristics and magic options.\n\nRaces:\n| Terrians\n| Argens\n| Avians\n| Majuu\n\nLeave the database by entering 'Leave'. Go back to the home prompt by entering 'Back'.\n")

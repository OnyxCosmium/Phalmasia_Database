...
while infoBarrier == "" or infoBarrier == "Return" or infoBarrier == "return":
    ...
    while infoBarrier == "Locations" or infoBarrier == "locations":
        ...
        while locationBarrier == "Mu'karr" or locationBarrier == "mu'karr" or locationBarrier == "Mukarr" or locationBarrier == "mukarr":
            ...
            while mukarrLocations != "Trefaeli" and mukarrLocations != "trefaeli" and mukarrLocations != "Andromita" and mukarrLocations != "andromita" and mukarrLocations != "Dragolyne" and mukarrLocations != "dragolyne" and mukarrLocations != "Meteora" and mukarrLocations != "meteora" and mukarrLocations != "Forecyor" and mukarrLocations != "forecyor" and mukarrLocations != "Dendraiye" and mukarrLocations != "dendraiye" and mukarrLocations != "Aurora Grotto" and mukarrLocations != "Aurora grotto" and mukarrLocations != "aurora Grotto" and mukarrLocations != "aurora grotto" and mukarrLocations != "Sundrop Valley" and mukarrLocations != "sundrop Valley" and mukarrLocations != "Sundrop valley" and mukarrLocations != "sundrop valley" and mukarrLocations != "Leave" and mukarrLocations != "leave" and mukarrLocations != "Back" and mukarrLocations != "back":
                mukarrLocations = input("Please Re-enter your database restriction.\n")

            # Trefaeli City Commands
            if mukarrLocations == "Trefaeli" or mukarrLocations == "trefaeli":
                ...
                mukarrLocation = input(
                    trefaeliStats + trefaeliDescription + "Go back to the other cities of Mu'karr by pressing 'Enter'.\n")

            # Andromita City Commands
            if mukarrLocations == "Andromita" or mukarrLocations == "andromita":
                ...
                mukarrLocation = input(
                    andromitaStats + andromitaDescription + "Go back to the other cities of Mu'karr by pressing 'Enter'.\n")

            # Dragolyne City Comamnds
            if mukarrLocations == "Dragolyne" or mukarrLocations == "dragolyne":
                ...
                mukarrLocation = input(
                    dragolyneStats + dragolyneDescription + "Go back to the other cities of Mu'karr by pressing 'Enter'.\n")

            # Meteora City Commands
            if mukarrLocations == "Meteora" or mukarrLocations == "meteora":
                ...
                mukarrLocation = input(
                    meteoraStats + meteoraDescription + "Go back to the other cities of Mu'karr by pressing 'Enter'.\n")

            # Forécyør City Comamnds
            if mukarrLocations == "Forecyor" or mukarrLocations == "forecyor":
                ...
                mukarrLocation = input(
                    forecyorStats + forecyorDescription + "Go back to the other cities of Mu'karr by pressing 'Enter'.\n")

            # Dendraiye City Commands
            if mukarrLocations == "Dendraiye" or mukarrLocations == "dendraiye":
                ...
                mukarrLocation = input(
                    dendraiyeStats + dendraiyeDescription + "Go back to the other cities of Mu'karr by pressing 'Enter'.\n")

            # Mu'karr: Mythic Location Commands
            # Aurora Grotto Commands
            if mukarrLocations == "Aurora Grotto" or mukarrLocations == "Aurora grotto" or mukarrLocations == "aurora Grotto" or mukarrLocations == "aurora grotto":
                ...
                mukarrLocation = input(
                    auroraGrottoStats + auroraGrottoDescription + "Go back to the other cities of Mu'karr by pressing 'Enter'.\n")

            # Sundrop Valley Commands
            if mukarrLocations == "Sundrop Valley" or mukarrLocations == "sundrop Valley" or mukarrLocations == "Sundrop valley" or mukarrLocations == "sundrop valley":
                ...
                mukarrLocation = input(
                    sundropValleyStats + sundropValleyDescription + "Go back to the other cities of Mu'karr by pressing 'Enter'.\n")

            # Mu'karr Exit Command
            if mukarrLocations == "Back" or mukarrLocations == "back":
                break
            if mukarrLocations == "Leave" or mukarrLocations == "leave":
                print("Database Search Completed. Please restart program to search again.")
                quit()
    ...
    while infoBarrier == "Magic" or infoBarrier == "magic":
        ...
        while magicBarrier != "Elemental Magic" and magicBarrier != "Elemental magic" and magicBarrier != "elemental Magic" and magicBarrier != "elemental magic" and magicBarrier != "Elemental" and magicBarrier != "elemental" and magicBarrier != "Lost Magic" and magicBarrier != "lost Magic" and magicBarrier != "Lost magic" and magicBarrier != "lost magic" and magicBarrier != "Lost" and magicBarrier != "lost" and magicBarrier != "Sigils" and magicBarrier != "sigils" and magicBarrier != "Mythical Elements" and magicBarrier != "mythical Elements" and magicBarrier != "Mythical elements" and magicBarrier != "mythical elements" and magicBarrier != "Mythical" and magicBarrier != "mythical" and magicBarrier != "Back" and magicBarrier != "back" and magicBarrier != "Leave" and magicBarrier != "leave":
            magicBarrier = input("Please Re-enter your database restriction.\n")

        # Elemental Magic Commands
        while magicBarrier == "Elemental Magic" or magicBarrier == "Elemental magic" or magicBarrier == "elemental Magic" or magicBarrier == "elemental magic" or magicBarrier == "Elemental" or magicBarrier == "elemental":
            ...
            while elementalBarrier != "Fire" and elementalBarrier != "fire" and elementalBarrier != "Water" and elementalBarrier != "water" and elementalBarrier != "Lightning" and elementalBarrier != "lightning" and elementalBarrier != "Wind" and elementalBarrier != "wind" and elementalBarrier != "Ice" and elementalBarrier != "ice" and elementalBarrier != "Earth" and elementalBarrier != "earth" and elementalBarrier != "Back" and elementalBarrier != "back" and elementalBarrier != "Leave" and elementalBarrier != "leave":
                elementalBarrier = input("Please Re-enter your database restriction.\n")

            # Fire Magic Commands
            if elementalBarrier == "Fire" or elementalBarrier == "fire":
            ...
            if elementalBarrier == "Water" or elementalBarrier == "water":
            ...
            if elementalBarrier == "Lightning" or elementalBarrier == "lightning":
            ...
            # Wind Magic Commands
            if elementalBarrier == "Wind" or elementalBarrier == "wind":
            ...
            # Ice Magic Commands
            if elementalBarrier == "Ice" or elementalBarrier == "ice":
            ...
            if elementalBarrier == "Earth" or elementalBarrier == "earth":
            ...
            if elementalBarrier == "Back" or elementalBarrier == "back":
                elementalBarrier = "Back"
                break
            if elementalBarrier == "Leave" or elementalBarrier == "leave":
                print("Database Search Completed. Please restart program to search again.")
                quit()

        # Lost Magic Commands
        while magicBarrier == "Lost Magic" or magicBarrier == "Lost magic" or magicBarrier == "lost Magic" or magicBarrier == "lost magic" or magicBarrier == "Lost" or magicBarrier == "lost":
            lostBarrier = input(
                "Lost Magic:\n| Shadow\n| Nature\n| Life\n| Gravity\n\nLeave the database by entering 'Leave'. Go back to magic selection prompt by entering 'Back'.\n")

            while lostBarrier == "":
                lostBarrier = input("Please Re-enter your database restriction.\n")
            while lostBarrier != "Shadow" and lostBarrier != "shadow" and lostBarrier != "Nature" and lostBarrier != "nature" and lostBarrier != "Life" and lostBarrier != "life" and lostBarrier != "Gravity" and lostBarrier != "gravity" and lostBarrier != "Back" and lostBarrier != "back" and lostBarrier != "Leave" and lostBarrier != "leave":
                lostBarrier = input("Please Re-enter your database restriction.\n")

            # Shadow Magic Commands
            if lostBarrier == "Shadow" or lostBarrier == "shadow":
            ...
            if lostBarrier == "Nature" or lostBarrier == "nature":
            ...
            # Life Magic Commands
            if lostBarrier == "Life" or lostBarrier == "life":
            ...
            if lostBarrier == "Gravity" or lostBarrier == "gravity":
            ...
            if lostBarrier == "Back" or lostBarrier == "back":
                lostBarrier = "Back"
                break
            if lostBarrier == "Leave" or lostBarrier == "leave":
                print("Database Search Completed. Please restart program to search again.")
                quit()

        # Sigils Commands
        while magicBarrier == "Sigils" or magicBarrier == "sigils":
            sigilBarrier = input(
                "Sigils:\n| About Sigils\n| Unity Sigils\n| Sectional Sigils\n\nLeave the database by entering 'Leave'. Go back to magic selection prompt by entering 'Back'.\n")

            while sigilBarrier == "":
                sigilBarrier = input("Please Re-enter your database restriction.\n")
            while sigilBarrier != "Unity Sigils" and sigilBarrier != "Unity sigils" and sigilBarrier != "unity Sigils" and sigilBarrier != "unity sigils" and sigilBarrier != "Sectional Sigils" and sigilBarrier != "Sectional sigils" and sigilBarrier != "sectional Sigils" and sigilBarrier != "sectional sigils" and sigilBarrier != "About Sigils" and sigilBarrier != "About sigils" and sigilBarrier != "about Sigils" and sigilBarrier != "about sigils" and sigilBarrier != "Sigils" and sigilBarrier != "sigils" and sigilBarrier != "Unity" and sigilBarrier != "unity" and sigilBarrier != "Sectional" and sigilBarrier != "sectional" and sigilBarrier != "Back" and sigilBarrier != "back" and sigilBarrier != "Leave" and sigilBarrier != "leave":
                sigilBarrier = input("Please Re-enter your database restriction.\n")

            # About Sigils Commands
            if sigilBarrier == "About Sigils" or sigilBarrier == "About sigils" or sigilBarrier == "about Sigils" or sigilBarrier == "about sigils" or sigilBarrier == "Sigils" or sigilBarrier == "sigils":
            ...
            if sigilBarrier == "Unity Sigils" or sigilBarrier == "Unity sigils" or sigilBarrier == "unity Sigils" or sigilBarrier == "unity sigils" or sigilBarrier == "Unity" or sigilBarrier == "unity":
            ...
            if sigilBarrier == "Sectional Sigils" or sigilBarrier == "Sectional sigils" or sigilBarrier == "sectional Sigils" or sigilBarrier == "sectional sigils" or sigilBarrier == "Sectional" or sigilBarrier == "sectional":
            ...
            # Sigil Exit Command
            if sigilBarrier == "Back" or sigilBarrier == "back":
                sigilBarrier = "Back"
                break
            if sigilBarrier == "Leave" or sigilBarrier == "leave":
                print("Database Search Completed. Please restart program to search again.")
                quit()

        # Mythical Elemental Commands
        while magicBarrier == "Mythical Elements" or magicBarrier == "mythical Elements" or magicBarrier == "Mythical elements" or magicBarrier == "mythical elements" or magicBarrier == "Mythical" or magicBarrier == "mythical":
            mythicBarrier = input(
                "Mythical Elements:\n| Dynamic Water\n| Zenith Earth\n| Cosmic Wind\n| Onyx Fire\n| Electron Lightning\n| Permafrost Ice\n\nLeave the database by entering 'Leave'. Go back to magic selection prompt by entering 'Back'.\n")

            while mythicBarrier == "":
                mythicBarrier = input("Please Re-enter your database restriction.\n")
            while mythicBarrier != "Dynamic Water" and mythicBarrier != "Dynamic water" and mythicBarrier != "dynamic Water" and mythicBarrier != "dynamic water" and mythicBarrier != "Zenith Earth" and mythicBarrier != "zenith Earth" and mythicBarrier != "Zenith earth" and mythicBarrier != "zenith earth" and mythicBarrier != "Cosmic Wind" and mythicBarrier != "Cosmic wind" and mythicBarrier != "cosmic Wind" and mythicBarrier != "cosmic wind" and mythicBarrier != "Onyx Fire" and mythicBarrier != "Onyx fire" and mythicBarrier != "onyx Fire" and mythicBarrier != "onyx fire" and mythicBarrier != "Electron Lightning" and mythicBarrier != "Electron lightning" and mythicBarrier != "electron Lightning" and mythicBarrier != "electron lightning" and mythicBarrier != "Permafrost Ice" and mythicBarrier != "Permafrost ice" and mythicBarrier != "permafrost Ice" and mythicBarrier != "permafrost ice" and mythicBarrier != "Back" and mythicBarrier != "back" and mythicBarrier != "Leave" and mythicBarrier != "leave":
                mythicBarrier = input("Please Re-enter your database restriction.\n")

            # Dynamic Water Commands
            if mythicBarrier == "Dynamic Water" or mythicBarrier == "Dynamic water" or mythicBarrier == "dynamic Water" or mythicBarrier == "dynamic water":
            ...
            if mythicBarrier == "Zenith Earth" or mythicBarrier == "zenith Earth" or mythicBarrier == "Zenith earth" or mythicBarrier == "zenith earth":
            ...
            if mythicBarrier == "Cosmic Wind" or mythicBarrier == "Cosmic wind" or mythicBarrier == "cosmic Wind" or mythicBarrier == "cosmic wind":
            ...
            if mythicBarrier == "Electron Lightning" or mythicBarrier == "Electron lightning" or mythicBarrier == "electron Lightning" or mythicBarrier == "electron lightning":
            ...
            if mythicBarrier == "Permafrost Ice" or mythicBarrier == "Permafrost ice" or mythicBarrier == "permafrost Ice" or mythicBarrier == "permafrost ice":
            ...
            if mythicBarrier == "Back" or mythicBarrier == "back":
                mythicBarrier = "Back"
                break
            if mythicBarrier == "Leave" or mythicBarrier == "leave":
                print("Database Search Completed. Please restart program to search again.")
                quit()

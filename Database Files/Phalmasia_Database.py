...
# Dynamic Water
# Zenith Earth
# Cosmic Wind: Aurora Grotto
# Onyx Fire: Sundrop Valley
# Electron Lightning
# Permafrost Ice
...
while infoBarrier == "" or infoBarrier == "return":
    ...
    while infoBarrier == "magic":
        ...
        while magicBarrier == "mythical elements" or magicBarrier == "mythical":
            mythicBarrier = input("Mythical Elements:\n| Dynamic Water\n| Zenith Earth\n| Cosmic Wind\n| Onyx Fire\n| Electron Lightning\n| Permafrost Ice\n\nLeave the database by entering 'Leave'. Go back to magic selection prompt by entering 'Back'.\n").lower()
    ...
    while infoBarrier == "races":
        raceBarrier = input("Besides humans, there are four different races that inhabit Phalmasia: Terrians, Argens, Avats, and Majuu. Each of them primarily inhabit one continent of Phalmasia, and have different ways of life, as well as unique characteristics and magic options. It is possible for some of these races to learn magic that isn't in their common subset, but it is very uncommon.\n\nRaces:\n| Terrians\n| Argens\n| Avats\n| Majuu\n\nLeave the database by entering 'Leave'. Go back to the home prompt by entering 'Back'.\n").lower()
    ...
    while infoBarrier == "history":
        ...
        if historyBarrier == "battle of judgement" or historyBarrier == "the battle of judgement" or dbsHistory == "next":
            ...
            bojHistory6 = "Xaeyz barraged Ryner with attacks from the sky where his kitsune could not reach, damaging him. The stardust from every wingflap of the phoenix landed on Mirago, and helped him to recover more quickly, enough so that he could fight for one last attack. Xaeyz and Mirago merged their beasts to create soemthing entirely new: a Dragonic Phoenix. Using the same attack they had used years ago to stop the Black Sun, they blasted Ryner with everything they had. It worked, and Ryner fell defeated to the ground.\n\n"
            bojHistory7 = "Realizing they had won, Xaeyz and Mirago used their magic to absorb Nova, the spirit of Electron Lightning, from Ryner's abusive control and store it in Xaeyz's body, leaving Ryner without the power of his mythical element forever. Returning to St. Guardia's, Xaeyz and Mirago announced their victory. However, because of Nova's presence, Xaeyz couldn't weild elemental magic without taking extreme recoil and was left with only gravity magic.\n\n"

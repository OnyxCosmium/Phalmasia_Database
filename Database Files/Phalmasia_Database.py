...
# Finish Locations Core Command
# Add the Establishment of St. Guardia's Academy to History Core Command
# Add Battle of Judgement (Ryner vs. Xaeyz & Mirago) to History Core Command
...
# Completed GitHub Repo for Database
# Added Race Abilities to All Races in Races Core Command
# Made a Previously Public Command Secret
# Added Spells to Some Characters
# Added Petalford to Mu'karr Cities Command
# Completed Locations Core Command (Completed Xhia Command)
...
while infoBarrier == "" or infoBarrier == "return":
        ...
        while characterBarrier == "xaeyz kai" or characterBarrier == "xaeyz":
            ...
            while xaeyzChapterPrompt == "chapters":
                ...
                if xaeyzChapterPrompt != "chapters" and xaeyzChapterPrompt != "chapter 1" and xaeyzChapterPrompt != "chapter one" and xaeyzChapterPrompt != "the day of black sun" and xaeyzChapterPrompt != "chapter 2" and xaeyzChapterPrompt != "chapter two" and xaeyzChapterPrompt != "the aurora scythe" and xaeyzChapterPrompt != "chapter 3" and xaeyzChapterPrompt != "chapter three" and xaeyzChapterPrompt != "the forest's shadow" and xaeyzChapterPrompt != "chapter 4" and xaeyzChapterPrompt != "chapter four" and xaeyzChapterPrompt != "hozura the flame" and xaeyzChapterPrompt != "":
                    xaeyzChapterPrompt = input("\nYou may have pressed enter on accident or misspelled your search. Please re-enter your search.").lower()
    ...
    while infoBarrier == "locations":
        ...
        while locationBarrier == "mu'karr" or locationBarrier == "mukarr":
            ...
            if mukarrLocations == "trefaeli":
                ...
                trefaeliDescription = "Trefaeli is a peaceful village in Southeastern Mu'karr. Due to the hilly terrain of the city, the trees aren't able to grow their roots completely underground, and many burst through to the surface. This causes the trees to grow strangely sideways, creating many archways of trees throughout the town. This adds a natural beauty to the village.\n\nThough there isn't much to do here, it is a producer of high-quality argenian clothing, though it isn't a major producer. They do sell their products to all of Mu'karr, but due to the size of Trefaeli, they can't afford to create high supplies.\n\n"
            ...
            if mukarrLocations == "dragolyne":
                ...
                dragolyneDescription = "Dragolyne is one of the largest cities in Mu'karr. It is an integration of both forestry and mountainous regions of Mu'karr, so the buildings and architecture throughout the town are varied depending on which region they reside in, adding a unique mix of personality into the town. This makes it a good place for visitors to want to come and learn about argenian culture.\n\nThis town also hosts the St. Guardia's Academy of Mu'karr, a sister academy of the one in Halgeis. Though they are the same academy, their curriculums are tailored to argens. The school has made Dragolyne a more lively place for residents, visitors, and their incoming students.\n\n"
        ...
        while locationBarrier == "xhia":
            ...
            if xhiaLocations == "clorohfyll":
                clorohfyllStats = "Clorohfyll, Xhia\n\nPrimary Resident Race: Majuu\nPronunciation: CLO-row-fill\nLocation: Northern Xhia\nVisitor Friendly: Yes\nSub-Locations:\n| St. Guardia's Academy\n\n"
                clorohfyllDescription = "Clorohfyll is the capital of Xhia. Being in the northern half of the continent, it's been torched by the embers of the war, draining the city of region exclusive flora, and of much of the natural beauty it once had. Though it bears a mark of embers, its residents haven't lost their spark of hope and friendliness. They still openly welcome non-majuu visitors, and are trying to restore the forest and lush plantlife surrounding their city. They have rebuilt over half the city after the fire, which leads to a contrast between ancient architecture and the new, modern-age designs. This makes it a popular place to learn about architecture and construction in Xhia, as well as across Phalmasia.\n\nClorohfyll got its name from the several different species of flora it had throughout the city, but after the great fire, it has since lost its significance. Clorofyll is also one of the only places in Xhia where combat can still be instructed. They have a St. Guardia's Academy of their own, where many Majuu apply to every year, hoping to get in. Because of the fact that it is one of the only schools in the region that can teach combat, many more students apply every year, resulting in the highest application rates of any St. Guardia's Academy, and a far lower acceptance rate. However, this also leads to high dropout rates, since many of those applying don't intend to become guardians and simply want magic or combat training.\n\n"
    ...
    while infoBarrier == "magic":
        magicBarrier = input("There is one additional magic classification that can only be accessed by those who are strong enough to wield them. Hints have been littered throughout the database. May the stars guide your way.\n\nMagic:\n| Elemental Magic\n| Lost Magic\n| Sigils\n\nLeave the database by entering 'Leave'. Go back to the home prompt by entering 'Back'.\n").lower()
        ...
        while magicBarrier == "mythical elements" or magicBarrier == "mythical element" or magicBarrier == "mythical" or magicBarrier == "mythic":
            ...
            if mythicBarrier == "zenith earth":
                ...
                zenithEarthDescription = "Zenith Earth is the Mythical Element of the Terrain, and Chrono is its spirit. Chrono is an extremely determined and trustworthy spirit. He always sticks up for those he cares about, as well as for the health of the terrain. His steadfast nature is perfect for commanding the earth to his bidding, and makes him a reliable friend. Zenith Earth provides a boosted number of nutrients to the plant life in the area, increasing their life force and allowing them to grow faster and into more beautiful plants, acting as a pseudo-nature magic. It is, of course, inferior to the real thing since it cannot manipulate the plants it grows.\n\nHowever, it's main strength lies in the ability to manipulate the phase of the earth he uses, changing it into lava. He can then use this transmuted lava as if he was earth and attack his target with it, making his attacks extremely deadly."
    ...
    while infoBarrier == "races":
        raceBarrier = input("Besides humans, there are four different races that inhabit Phalmasia: Terrians, Argens, Avats, and Majuu. Each of them primarily inhabit one continent of Phalmasia, and have different ways of life, as well as unique characteristics and magic options. It is possible for some of these races to learn magic that isn't in their common subset, but it is very uncommon. Humans, unfortunately, cannot learn magic. \n\nRaces:\n| Terrians\n| Argens\n| Avats\n| Majuu\n\nLeave the database by entering 'Leave'. Go back to the home prompt by entering 'Back'.\n").lower()
    ...
    while infoBarrier == "history":
        ...
        if historyBarrier == "the gifter's war" or historyBarrier == "the gifters war" or pdgHistory == "next":
            tgwHistory1 = "The Gifter's War & The Establishment of the Keepers\n| 1064 PDG - 1076 PDG\n\nAs the people were granted the gifts of their creators, they used all of the gifts together and made the land beautiful. They established life in large fields, high in the mountains, through the trees, and much more. They crafted buildings to live in; villages, towns, and cities rose from the ground up.\n\n"
            ...
            tgwHistory3 = "As the thought sat and grew in silence, the people began to argue, trying to display which of the Creators deserved more of the praise and which gifts had been more beneficial to their cause. Ghurrado stood and watched this great war. He was hurt, for they did not understand that they all equally contributed to bring them their new beloved world. If it had not been for all of this children and wife, the people would not have been able to craft the world in the way they wanted.\n\n"
        ...
        if historyBarrier == "battle of judgement" or historyBarrier == "the battle of judgement" or dbsHistory == "next":
            bojHistory1 = "The Battle of Judgement\n| 4042 PDG\n\nOn the graduation day of St. Guardia's in Halgeis, the Electron Lightning user Ryner made his first appearance. He threatened to destroy the guardians and everything they worked for, and promised to defeat anyone that got in his path. All the guardians, of course, rose up to stop him and told the students to evacuate. In response, Ryner put up a ring of lightning around all of the students, trapping them inside. Many of the students tried to break the cage, but they could barely do anything against it.\n\n"
            bojHistory2 = "Ryner then sped towards the guardians, ready to attack when he was stopped by The Forest's Shadow and repelled backwards. The shadow then used this strange force to destabilize the cage of lightning freeing the students. It dropped his hood to reveal Xaeyz, the boy who had dropped out of St. Guardia's the previous year. He revealed to the world then that he was the Cosmic Wind user, and would do everything he could to stop this threat.\n\n"
            bojHistory3 = "He had his friends Yggdra, Mimi, Cid, Aeiyou and Kimiko help to evacuate everyone with the help of the guardians. Ryner, again tried to stop them, but this time Xaeyz held him back with his wind magic. Turning to Ryner in rage, he quickly flew up to him, dodging his attacks and using a powerful push spell to send Ryner flying away from the academy to a battlefield where civilians wouldn't be in the way. It was here that Mirago appeared and joined the fight to stop this great threat once and for all.\n\n"
            bojHistory4 = "This battle lasted for two days and nights, as the terrain around them became more and more destroyed. Ryner's shadow magic proved to be difficult to dealing with, especially since it could shut off magic flow, but Xaeyz could counter it with gravity, and Mirago could absorb his attacks with his Life magic. Their battle eventually only consisted of an onslaught of Mythical Elements: Onyx Fire, Cosmic Wind, and Electron Lightning attacks were thrown at high speeds.\n\n"
            bojHistory5 = "Eventually, Ryner got the upper hand, and hit Mirago with a blast of lightning, taking him down. Xaeyz tries his best to defend Mirago until he can recover himself, but he fails and is hit himself. It was then that Xaeyz snapped. Magic exploded from his body in a torrent of rage, and as a result, his Cosmic Wind merged with his phoenix form. In response, Ryner summoned his kaijū, and the battle began anew. But this time, Xaeyz had the advantage.\n\n"
            bojHistory6 = "Xaeyz barraged Ryner with attacks from the sky where his kitsune could not reach, damaging him. The stardust from every wing flap of the phoenix landed on Mirago, and helped him to recover more quickly, enough so that he could fight for one last attack. Xaeyz and Mirago merged their beasts to create something entirely new: a Dragonic Phoenix. Using the same attack they had used years ago to stop the Black Sun, they blasted Ryner with everything they had. It worked, and Ryner fell defeated to the ground.\n\n"
            bojHistory7 = "Realizing they had won, Xaeyz and Mirago used their magic to absorb Nova, the spirit of Electron Lightning, from Ryner's abusive control and store it in Xaeyz's body, leaving Ryner without the power of his *mythical element* forever. Returning to St. Guardia's, Xaeyz and Mirago announced their victory. However, because of Nova's presence, Xaeyz couldn't wield elemental magic without taking extreme recoil and was left with only gravity magic.\n\n"
            bojHistory8 = "The toll of carrying two *Mythic* Spirits also put a heavy stress on his body, and he realized he only had about a year left to live if he continued to hold on to Nova. Xaeyz said goodbye to his friends at St. Guardia's one last time, and went with Mirago to travel the world, looking for a worthy lightning user to be the new wielder of Electron Lightning.\n\n"

...
# Electron Lightning: Cloudpeek Mountain, Altaria
# Permafrost Ice: Snowflake Glacier, Altaria
...
# Added Three New Secret Locations
...
while infoBarrier == "" or infoBarrier == "return":
    ...
    while infoBarrier == "characters":
        ...
        # Serena Fynae Bio
        while characterBarrier == "serena fynae" or characterBarrier == "serena":
            # Serena Bio Prompts
    ...
    while infoBarrier == "locations":
        ...
        while locationBarrier == "mu'karr" or locationBarrier == "mukarr":
            ...
            while mukarrLocations != "trefaeli" and mukarrLocations != "andromita" and mukarrLocations != "dragolyne" and mukarrLocations != "meteora" and mukarrLocations != "forecyor" and mukarrLocations != "dendraiye" and mukarrLocations != "aurora grotto" and mukarrLocations != "sundrop valley" and mukarrLocations != "leave" and mukarrLocations != "back":
                mukarrLocations = input("Please Re-enter your database restriction.\n").lower()
        ...
        while locationBarrier == "altaria":
            ...
            if altariaLocations == "entrype":
                ...
                altariaLocation = input(entrypeStats + entrypeDescription + "Go back to the other cities of Mu'karr by pressing 'Enter'.\n").lower()
            ...
            if altariaLocations == "soraikai":
                ...
                altariaLocation = input(soraikaiStats + soraikaiDescription + "Go back to the other cities of Mu'karr by pressing 'Enter'.\n").lower()
            ...
            if altariaLocations == "cerulaine":
                ...
                altariaLocation = input(cerulaineStats + cerulaineDescription + "Go back to the other cities of Mu'karr by pressing 'Enter'.\n").lower()
            ...
            if altariaLocations == "luminour":
                ...
                altariaLocation = input(luminourStats + luminourDescription + "Go back to the other cities of Mu'karr by pressing 'Enter'.\n").lower()
            ...
            if altariaLocations == "keravine":
                ...
                altariaLocation = input(keravineStats + keravineDescription + "Go back to the other cities of Mu'karr by pressing 'Enter'.\n").lower()
            ...
            if altariaLocations == "thornhaven":
                ...
                altariaLocation = input(thornhavenStats + thornhavenDescription + "Go back to the other cities of Mu'karr by pressing 'Enter'.\n").lower()
            ...
            if altariaLocations == "manafield":
                ...
                altariaLocation = input(manafieldStats + manafieldDescription + "Go back to the other cities of Mu'karr by pressing 'Enter'.\n").lower()
    ...
    while infoBarrier == "magic":
        magicBarrier = input("There is one additional magic classification that can only be accessed by those who know its name. Hints have been littered throughout the database. May the stars guide your way.\n\nMagic:\n| Elemental Magic\n| Lost Magic\n| Sigils\n\nLeave the database by entering 'Leave'. Go back to the home prompt by entering 'Back'.\n").lower()
